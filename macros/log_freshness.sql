{% macro log_freshness(results) %}
    ...
    {% for source in graph.sources.values() -%}
        ...
        {% set source_freshness=source['config']['freshness'] %}
        {% if source_freshness['error_after']['count'] == null and source_freshness['warn_after']['count'] == null %}
            {% set source_freshness=None %}
        {% endif %}
        ...
        {% do rows.append({
            ...
            "name": source['name'],
            "freshness_source": 'yml_config',
            "freshness_keywords": null,
            "freshness_config": source_freshness
        }) %}
    {% endfor %}
